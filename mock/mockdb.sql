...
CREATE TABLE `customer` (
    ...
    `create_admin`       int(4) DEFAULT 0 NOT NULL,
    `update_admin`       int(4),
...
CREATE TABLE `count` (
  ...
  `count_date`              date,
  `count_ts`                timestamp DEFAULT current_timestamp,
  `data`                    mediumtext,
...
INSERT INTO `customer` (`first`, `last`, `address`, `city`, `state`, `postal`, `phone`, `alt_phone`, `email`)
VALUES
...
INSERT INTO `staff` (`staff_id`, `last`, `first`, `address`, `city`, `state`, `postal`, `phone`, `alt_phone`, `email`, `role_id`)
VALUES
    (0, 'System', 'Store', null, null, null, null, '678-555-5555', null, 'system@salon.com', 4000),
...
INSERT INTO `addon` (`add_on_id`, `name`, `timeblock`)
VALUES
...
(3000, 'Moroccan', 'Moisture Repair Shampoo', 'Shampoo',  '8 oz', 12.00, 27.00, 227566558867),
(3000, 'Moroccan', 'Moisture Repair Conditioner', 'Conditioner', '8 oz', 12.50, 28.12, 919019856491),
(3000, 'Moroccan', 'Hydrating Shampoo', 'Shampoo',  '8 oz', 11.50, 25.87, 718873382546),
(3000, 'Moroccan', 'Hydrating Conditioner', 'Conditioner', '8 oz', 12.00, 27.00, 774564438965),
(3000, 'Moroccan', 'Extra Volume Shampoo', 'Shampoo',  '8 oz', 12.00, 27.00, 51101812627),
(3000, 'Moroccan', 'Extra Volume Conditioner', 'Conditioner', '8 oz', 12.50, 28.12, 637192695867),
(3000, 'Moroccan', 'Smoothing Shampoo', 'Shampoo',  '8 oz', 14.00, 31.50, 344624893274),
(3000, 'Moroccan', 'Smoothing Conditioner', 'Conditioner', '8 oz', 14.50, 32.63, 574246705975),
(3000, 'Moroccan', 'Moroccan Oil', 'Oil', '3 oz', 22.00, 49.50, 482527089305),
(3000, 'Moroccan', 'Moroccan Oil', 'Oil', '1 oz', 8.50, 19.12, 741540414281),
(3000, 'Moroccan', 'Moroccan Oil Lite', 'Oil', '3 oz', 22.00, 49.50, 622789966408),
(3000, 'Moroccan', 'Morroccin Oil Lite', 'Oil', '1 oz', 8.50, 19.12, 215950558893),
(3000, 'Moroccan', 'Hyrdrating Styling Cream', 'Styling Aid', '10 oz', 17.00, 38.25, 514043293428),
(3000, 'Moroccan', 'Intense Curl Cream', 'Styling Aid', '10 oz', 17.00, 38.25, 612160380464),
(3000, 'Moroccan', 'Curl Control Mousse', 'Mousse', '8 oz', 14.50, 32.63, 916390243452),
(3000, 'Moroccan', 'Styling Gel Medium', 'Styling Aid', '6 oz', 10.00, 22.50, 793564316817),
(3000, 'Moroccan', 'Molding Cream', 'Styling Aid', '3 oz', 14.00, 31.50, 501372893807),
(3000, 'Moroccan', 'Curl Defining Cream', 'Styling Aid', '8 oz', 17.00, 38.25, 286277108360),
(3000, 'Moroccan', 'Thickening Lotion', 'Styling Aid', '3 oz', 14.50, 32.63, 538560669404),
(3000, 'Moroccan', 'Root Boost', 'Styling Aid', '8 oz', 14.50, 32.63, 305236345622),
(3000, 'Moroccan', 'Volumizing Mousse', 'Mousse', '8 oz', 14.95, 33.64, 633809675928),
(3000, 'Moroccan', 'Luminous Hairspray Medium', 'Hairspray', '10 oz', 12.00, 27.00, 463329283055),
(3000, 'Moroccan', 'Luminous Hairspray Strong', 'Hairspray', '10 oz', 12.00, 27.00, 253224969841),
(3000, 'Moroccan', 'Luminous Hairspray Extra Strong', 'Hairspray', '10 oz', 12.00, 27.00, 691610307899),
